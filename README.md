...
>
> The configuration file is stored at: `C:\Users\[USERNAME]\AppData\Roaming\interview-everything\config.json` (on Windows) or `/Users/[USERNAME]/Library/Application Support/interview-everything/config.json` (on macOS)
...
- Screen Recording Permission for Terminal/IDE
  - On macOS:
    ...
    2. Ensure that Interview Everything has screen recording permission enabled
    3. Restart Interview Everything after enabling permissions
  - On Windows:
...
```bash
git clone https://github.com/MARKYangL/interview-everything.git
cd interview-everything
```
...
| Feature | Premium Tools (Paid) | Interview Everything (This Project) |
|---------|------------------------|----------------------------------------|
