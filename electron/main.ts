...
// Register the interview-everything protocol
if (process.platform === "darwin") {
  app.setAsDefaultProtocolClient("interview-everything")
} else {
  app.setAsDefaultProtocolClient("interview-everything", process.execPath, [
...
async function initializeApp() {
  try {
    ...
    const appDataPath = path.join(app.getPath('appData'), 'interview-everything')
